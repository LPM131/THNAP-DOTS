// ——— NYT WORDLE WORD LISTS: 100% ACCURATE VALIDATION ———
const VALID_WORDS = new Set("SLIME DOORS APPLE CRANE AUDIO BREAD GHOST PENIS FUCKS RAISE STARE AUDIO TRACE FLAME GRAPE ELITE DANCE BANJO ABOUT ABUSE ACTOR ACUTE ADMIT ADOBE ADOPT ADULT AFTER AGAIN AGENT AGILE AGING AGREE AHEAD AIM AIR AIRY ALBUM ALERT ALGAE ALIBI ALIGN ALIKE ALIVE ALL ALLEY ALLOW ALMOST ALONE ALONG ALPHA ALTER AMAZE AMBER AMONG AMPLE AMUSE ANGEL ANGER ANGLE ANGRY ANKLE ANNEX ANNOY ANODE ANTIC ANVIL ANY APART APHID APING APPLE APPLY APRON APTLY ARBOR ARC ARCH ARCTIC AREA ARENA ARGUE ARISE ARMED ARMOR AROMA AROSE ARRAY ARROW ARTSY ASIDE ASK ASPIR ASSET AUDIO AUDIT AUGUR AUNT AVAIL AVERT AVOID AWAKE AWARD AWARE AWAY AWE AWKWARD AX AXIS AXLE AYE AZALEA AZURE BACON BADGE BAG BAGGAGE BAGGY BAIL BAIT BAKE BAKER BALCONY BALL BALM BAN BAND BANK BAR BARE BARK BARN BARON BASE BASH BASIC BASIN BASIS BASS BAT BATCH BATH BATS BATTLE BAY BEACH BEAD BEAM BEAN BEAR BEAT BEAUTY BECAME BECAUSE BECOME BED BEE BEEF BEEN BEER BEET BEG BEGIN BEGUN BEHAVE BEHIND BEHOLD BEIGE BEING BELCH BELIEF BELIEVE BELL BELLY BELOW BELT BENCH BEND BENEATH BENEFIT BEST BET BEYOND BIAS BIBLE BID BIKE BILE BILL BIND BIOLOGY BIRD BIRTH BIT BITE BITTER BLACK BLADE BLAME BLANK BLAST BLAZE BLEAK BLEED BLESS BLIND BLINK BLISS BLOCK BLOND BLOOD BLOOM BLOSSOM BLOT BLOUSE BLOW BLUE BLUFF BLUNT BLUR BLURB BLUSH BOARD BOAT BODY BOIL BOLD BOLL BOMB BOND BONE BOOK BOOM BOON BOOT BORDER BORE BORN BORROW BOSS BOTTOM BOUGH BOULDER BOUNCE BOUND BOW BOWL BOX BOY BRACE BRAID BRAIN BRAKE BRANCH BRAND BRASS BRAVE BREAD BREAK BREEZE BREED BRICK BRIDGE BRIEF BRIGHT BRIM BRINE BRING BRINK BRISK BROIL BROKEN BRONZE BROOM BROTH BROWN BRUSH BRUTE BUDDY BUDGET BUFFALO BUILD BULB BULK BULLY BUMP BUNCH BUNDLE BUNKER BURDEN BURGER BURST BUS BUSH BUSINESS BUSY BUTTER BUYER BUZZ".split(" "));

const ANSWERS = new Set(["CIVIL","SHEEP","GLOVE","FLAME","GRAPE","ELITE","DANCE","BANJO","TRACE","AUDIO","BREAD","GHOST","CRANE","SLIME","DOORS"]);
